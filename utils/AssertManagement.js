...
class AssertManagement {
  assertResponseStatusCode(response, expectedStatusCode) {
    console.log(
      `Asserts that Response Status code is '${expectedStatusCode}'.`
    );
  ...
  assertResponseBodyKeyPresent(responseBody, expectedKeyName) {
    console.log(
      `Asserts that Response Body has property: '${expectedKeyName}'.`
    );
  ...
  assertResponseBodyKeyValue(responseBody, expectedKeyName, expectedValue) {
    console.log(
      `Asserts that Response Body has key: '${expectedKeyName}' with value: '${expectedValue}'.`
    );
    expect(responseBody[expectedKeyName]).toBe(expectedValue);
  }
}

export default new AssertManagement
